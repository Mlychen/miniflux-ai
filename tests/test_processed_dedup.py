...
class TestProcessedDedup(unittest.TestCase):
    def test_processed_repository_checks_canonical_id(self):
        entry = {"id": 4889, "url": "https://example.com/a?utm_source=x", "title": "Hello", "content": "c"}
