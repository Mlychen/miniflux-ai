...
class TestProcessEntrySkip(unittest.TestCase):
    def test_skip_without_preprocess_when_all_agents_filtered(self):
        entry = {
            "id": 1,
    ...
    def test_all_agents_filtered_marks_processed_repository(self):
        entry = {
            "id": 2,
